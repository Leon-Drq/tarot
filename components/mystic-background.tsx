    ...
    <div className="allow-scroll home-hero-stage relative min-h-screen overflow-x-hidden bg-mystic-bg">
      ...
      <div className="relative min-h-[142svh] overflow-visible pb-[calc(env(safe-area-inset-bottom)+6rem)] sm:min-h-[132svh] md:min-h-[124svh] md:pb-28">
        ...
        <div
          ...
          className="absolute left-0 right-0 top-[var(--home-hero-light-y)] z-20 flex h-0 justify-center overflow-visible"
        >
          <div
          ...
          >
            <div
              ...
              aria-hidden="true"
              className="pointer-events-none absolute left-0 top-0 z-0 h-[min(78vw,34rem)] w-[min(78vw,34rem)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(246,244,255,0.54)_0%,rgba(170,161,255,0.32)_32%,rgba(76,42,120,0.14)_58%,transparent_76%)] blur-2xl mix-blend-screen md:h-[34rem] md:w-[34rem]"
            />
            ...
            <div
              ...
              className="absolute left-0 top-0 z-10 -translate-x-1/2 -translate-y-1/2 overflow-visible"
            >
              <TarotCard
