  ...
  en: {
    ...
    quickStartGroups: [
      ...
      },
      {
        ...
        body: "For daily and weekly love, work, yes-or-no, mood, and action prompts that build a habit.",
        slugs: ["tarot-card-of-the-day", "daily-tarot-card", "love-tarot-card-of-the-day", "daily-love-tarot", "daily-career-tarot", "daily-yes-or-no-tarot", "weekly-tarot-reading", "weekly-love-tarot", "weekly-career-tarot"],
      },
    ],
    groups: [
      {
    ...
    entries: [
      ...
      },
      {
        ...
        title: "Does he miss me?",
        query: "Does he miss me, and what does his silence really mean?",
        intent: "For silence, delayed replies, emotional distance, no-contact periods, and whether longing may become action.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "is-he-hiding-his-feelings-tarot",
        title: "Is he hiding his feelings?",
        query: "Is he hiding his feelings, and what should I observe before I act?",
        intent: "For guarded behavior, private emotion, fear of vulnerability, and mixed signals.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "why-did-he-pull-away-tarot",
        title: "Why did he pull away?",
        query: "Why did he pull away, and what is the healthiest next step for me?",
        intent: "For sudden distance, fewer texts, avoidant behavior, and deciding whether to wait, talk, or step back.",
        spread: "their_thoughts",
        group: "love",
      },
      {
      ...
      },
      {
        ...
        title: "Does she miss me?",
        query: "Does she miss me, and what does her silence really mean?",
        intent: "For silence, delayed replies, emotional distance, no-contact periods, and whether longing may become action.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        ...
        title: "Is she hiding her feelings?",
        query: "Is she hiding her feelings, and what should I observe before I act?",
        intent: "For guarded behavior, private emotion, fear of vulnerability, and mixed signals.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        ...
        title: "Why did she pull away?",
        query: "Why did she pull away, and what is the healthiest next step for me?",
        intent: "For sudden distance, fewer texts, avoidant behavior, and deciding whether to wait, talk, or step back.",
        spread: "their_thoughts",
        group: "love",
      },
      ...
      },
      {
        ...
        title: "Will I get money?",
        query: "Will I get money, and what practical step should I take next?",
        intent: "For money improvement, income timing, pending payments, resources, and one grounded action.",
        spread: "three_card",
        group: "career",
      },
      {
        slug: "should-i-spend-money-tarot",
        title: "Should I spend money?",
        query: "Should I spend this money now, or wait?",
        intent: "For purchases, subscriptions, trips, courses, gifts, and pausing before a material decision.",
        spread: "yes_no",
        group: "career",
      },
      {
        ...
        query: "What should I understand about my financial future and next practical move?",
        intent: "For money patterns, resources, timing, financial pressure, and the next controllable step.",
        spread: "three_card",
        group: "career",
      },
      {
        ...
        query: "What tarot card should guide my day today?",
        intent: "For one free card, today's energy, a clear message, and a practical next step.",
        spread: "single_card",
        group: "daily",
      },
      {
        ...
        query: "What is my daily tarot card trying to show me?",
        intent: "For a quick daily card habit with AI guidance, notes, and tomorrow's return cue.",
        spread: "single_card",
        group: "daily",
      },
      {
        ...
        query: "What love energy should I understand today?",
        intent: "For today's relationship energy, feelings, communication, and one grounded next step.",
        spread: "love_connection",
        group: "daily",
      },
      {
      ...
      },
      {
        ...
        query: "What theme should guide my week, and what practical focus should I keep?",
        intent: "For a week-ahead theme, repeated Daily Tarot patterns, and one practical priority.",
        spread: "three_card",
        group: "daily",
      },
      {
        ...
        query: "What should I understand about love this week, and what action keeps me clear?",
        intent: "For relationship energy, communication, timing, and one calm next step this week.",
        spread: "relationship",
        group: "daily",
      },
      {
        ...
        query: "What should I focus on in my career this week, and what move would help?",
        intent: "For work pressure, opportunity, preparation, and one practical career move this week.",
        spread: "job_opportunity",
        group: "daily",
      },
      {
  ...
  es: {
    ...
    quickStartGroups: [
      ...
      },
      {
        ...
        body: "Para amor, carrera, si/no, estado de animo y acciones diarias o semanales que crean habito.",
        slugs: ["tarot-card-of-the-day", "daily-tarot-card", "love-tarot-card-of-the-day", "daily-love-tarot", "daily-career-tarot", "daily-yes-or-no-tarot", "weekly-tarot-reading", "weekly-love-tarot", "weekly-career-tarot"],
      },
    ],
    groups: [
    ...
    entries: [
      ...
      },
      {
        slug: "does-he-miss-me-tarot",
        title: "El me extrana?",
        query: "El me extrana y que significa realmente su silencio?",
        intent: "Para silencio, respuestas tardias, distancia emocional, contacto cero y si la nostalgia puede volverse accion.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "is-he-hiding-his-feelings-tarot",
        title: "Oculta sus sentimientos?",
        query: "Oculta sus sentimientos y que debo observar antes de actuar?",
        intent: "Para conducta reservada, emocion privada, miedo a mostrarse vulnerable y senales mixtas.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "why-did-he-pull-away-tarot",
        title: "Por que se alejo?",
        query: "Por que se alejo y cual es el siguiente paso mas sano para mi?",
        intent: "Para distancia repentina, menos mensajes, conducta evitativa y decidir si esperar, hablar o tomar distancia.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "does-she-miss-me-tarot",
        title: "Ella me extrana?",
        query: "Ella me extrana y que significa realmente su silencio?",
        intent: "Para silencio, respuestas tardias, distancia emocional, contacto cero y si la nostalgia puede volverse accion.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "is-she-hiding-her-feelings-tarot",
        title: "Ella oculta sus sentimientos?",
        query: "Ella oculta sus sentimientos y que debo observar antes de actuar?",
        intent: "Para conducta reservada, emocion privada, miedo a mostrarse vulnerable y senales mixtas.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "why-did-she-pull-away-tarot",
        title: "Por que ella se alejo?",
        query: "Por que ella se alejo y cual es el siguiente paso mas sano para mi?",
        intent: "Para distancia repentina, menos mensajes, conducta evitativa y decidir si esperar, hablar o tomar distancia.",
        spread: "their_thoughts",
        group: "love",
      },
      ...
      {
        slug: "will-i-get-money-tarot",
        title: "Recibire dinero?",
        query: "Recibire dinero y que paso practico debo tomar ahora?",
        intent: "Para mejora economica, pagos pendientes, recursos, timing y una accion concreta.",
        spread: "three_card",
        group: "career",
      },
      {
        slug: "should-i-spend-money-tarot",
        title: "Debo gastar dinero?",
        query: "Debo gastar este dinero ahora o esperar?",
        intent: "Para compras, suscripciones, viajes, cursos, regalos y pausar antes de una decision material.",
        spread: "yes_no",
        group: "career",
      },
      {
        slug: "financial-future-tarot-reading",
        title: "Futuro financiero tarot",
        query: "Que debo entender sobre mi futuro financiero y mi proximo movimiento practico?",
        intent: "Para patrones economicos, recursos, timing, presion financiera y un paso controlable.",
        spread: "three_card",
        group: "career",
      },
      {
        slug: "tarot-card-of-the-day",
        title: "Carta de tarot del dia",
        query: "Que carta de tarot debe guiar mi dia hoy?",
        intent: "Para una carta gratis, la energia de hoy, un mensaje claro y un siguiente paso.",
        spread: "single_card",
        group: "daily",
      },
      {
        ...
        query: "Que intenta mostrarme mi carta diaria de tarot?",
        intent: "Para un habito rapido de carta diaria con guia de IA, notas y retorno manana.",
        spread: "single_card",
        group: "daily",
      },
      {
        slug: "love-tarot-card-of-the-day",
        title: "Carta de tarot del amor del dia",
        query: "Que energia de amor debo entender hoy?",
        intent: "Para energia de relacion, sentimientos, comunicacion y un siguiente paso claro hoy.",
        spread: "love_connection",
        group: "daily",
      },
      {
      ...
      },
      {
        ...
        query: "Que tema debe guiar mi semana y que foco practico debo mantener?",
        intent: "Para un tema de la semana, patrones repetidos de Tarot Diario y una prioridad practica.",
        spread: "three_card",
        group: "daily",
      },
      {
        ...
        query: "Que debo entender sobre el amor esta semana y que accion me mantiene clara?",
        intent: "Para energia de relacion, comunicacion, timing y un siguiente paso tranquilo esta semana.",
        spread: "relationship",
        group: "daily",
      },
      {
        ...
        query: "En que debo enfocarme en mi carrera esta semana y que movimiento ayudaria?",
        intent: "Para presion laboral, oportunidades, preparacion y un paso profesional practico esta semana.",
        spread: "job_opportunity",
        group: "daily",
      },
      {
  ...
  "pt-br": {
    ...
    quickStartGroups: [
      ...
      },
      {
        ...
        body: "Para amor, carreira, sim/nao, humor e acoes diarias ou semanais que criam habito.",
        slugs: ["tarot-card-of-the-day", "daily-tarot-card", "love-tarot-card-of-the-day", "daily-love-tarot", "daily-career-tarot", "daily-yes-or-no-tarot", "weekly-tarot-reading", "weekly-love-tarot", "weekly-career-tarot"],
      },
    ],
    groups: [
    ...
    entries: [
      ...
      {
        slug: "does-he-miss-me-tarot",
        title: "Ele sente minha falta?",
        query: "Ele sente minha falta e o que o silencio dele realmente significa?",
        intent: "Para silencio, respostas demoradas, distancia emocional, contato zero e se saudade pode virar acao.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "is-he-hiding-his-feelings-tarot",
        title: "Ele esconde os sentimentos?",
        query: "Ele esconde os sentimentos e o que devo observar antes de agir?",
        intent: "Para comportamento reservado, emocao privada, medo de vulnerabilidade e sinais mistos.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        ...
        query: "Por que ele se afastou e qual e o proximo passo mais saudavel para mim?",
        intent: "Para distancia repentina, menos mensagens, comportamento evitativo e decidir se espera, conversa ou recua.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "does-she-miss-me-tarot",
        title: "Ela sente minha falta?",
        query: "Ela sente minha falta e o que o silencio dela realmente significa?",
        intent: "Para silencio, respostas demoradas, distancia emocional, contato zero e se a saudade pode virar acao.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "is-she-hiding-her-feelings-tarot",
        title: "Ela esconde os sentimentos?",
        query: "Ela esconde os sentimentos e o que devo observar antes de agir?",
        intent: "Para comportamento reservado, emocao privada, medo de vulnerabilidade e sinais mistos.",
        spread: "their_thoughts",
        group: "love",
      },
      {
        slug: "why-did-she-pull-away-tarot",
        title: "Por que ela se afastou?",
        query: "Por que ela se afastou e qual e o proximo passo mais saudavel para mim?",
        intent: "Para distancia repentina, menos mensagens, comportamento evitativo e decidir se espera, conversa ou recua.",
        spread: "their_thoughts",
        group: "love",
      },
      ...
      {
        slug: "will-i-get-money-tarot",
        title: "Vou receber dinheiro?",
        query: "Vou receber dinheiro e que passo pratico devo tomar agora?",
        intent: "Para melhora financeira, pagamentos pendentes, recursos, timing e uma acao concreta.",
        spread: "three_card",
        group: "career",
      },
      {
        slug: "should-i-spend-money-tarot",
        title: "Devo gastar dinheiro?",
        query: "Devo gastar este dinheiro agora ou esperar?",
        intent: "Para compras, assinaturas, viagens, cursos, presentes e pausar antes de uma decisao material.",
        spread: "yes_no",
        group: "career",
      },
      {
        slug: "financial-future-tarot-reading",
        title: "Futuro financeiro tarot",
        query: "O que devo entender sobre meu futuro financeiro e meu proximo movimento pratico?",
        intent: "Para padroes financeiros, recursos, timing, pressao financeira e um passo controlavel.",
        spread: "three_card",
        group: "career",
      },
      {
        ...
        query: "Que carta de tarot deve guiar meu dia hoje?",
        intent: "Para uma carta gratis, a energia de hoje, uma mensagem clara e um proximo passo.",
        spread: "single_card",
        group: "daily",
      },
      {
        slug: "daily-tarot-card",
        title: "Carta diaria de tarot",
        query: "O que minha carta diaria de tarot quer me mostrar?",
        intent: "Para um habito rapido de carta diaria com guia de IA, notas e retorno amanha.",
        spread: "single_card",
        group: "daily",
      },
      {
        ...
        query: "Que energia de amor devo entender hoje?",
        intent: "Para energia de relacionamento, sentimentos, comunicacao e um proximo passo claro hoje.",
        spread: "love_connection",
        group: "daily",
      },
      {
      ...
      },
      {
        ...
        query: "Que tema deve guiar minha semana e que foco pratico devo manter?",
        intent: "Para um tema da semana, padroes repetidos do Tarot Diario e uma prioridade pratica.",
        spread: "three_card",
        group: "daily",
      },
      {
        ...
        query: "O que devo entender sobre amor esta semana e que acao me mantem clara?",
        intent: "Para energia de relacionamento, comunicacao, timing e um proximo passo tranquilo esta semana.",
        spread: "relationship",
        group: "daily",
      },
      {
        ...
        query: "No que devo focar na carreira esta semana e que movimento ajudaria?",
        intent: "Para pressao no trabalho, oportunidades, preparacao e um passo profissional pratico esta semana.",
        spread: "job_opportunity",
        group: "daily",
      },
      {
