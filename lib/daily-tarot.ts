  ...
  return (
    {
      zh: {
        ...
        calendarFallbackBody: "下载一次日历文件后，手机日历会每天提醒你回到 Daily Tarot；邮件服务接通后会按你的偏好发送。",
      ...
      en: {
        ...
        calendarFallbackBody: "Download the calendar file once and your phone calendar can remind you to return to Daily Tarot. Email delivery will use this preference after it is connected.",
      ...
      ja: {
        ...
        calendarFallbackBody: "カレンダーファイルを一度ダウンロードすると、スマホのカレンダーで毎日通知できます。メール送信が接続されると、この設定で送信されます。",
      ...
      ko: {
        ...
        calendarFallbackBody: "캘린더 파일을 한 번 다운로드하면 휴대폰 캘린더가 매일 Daily Tarot 방문을 알려줍니다. 이메일 발송이 연결되면 이 설정대로 발송됩니다.",
