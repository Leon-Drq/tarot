  ...
  return (
    {
      zh: {
        ...
        calendarFallbackBody: "邮件发送服务还在接入中。你可以先保存提醒偏好，同时下载日历提醒，让手机日历每天提醒你回来。",
      ...
      en: {
        ...
        calendarFallbackBody: "Email delivery is still being connected. You can save the email preference now and download a calendar reminder so your phone brings you back every day.",
      ...
      ja: {
        ...
        calendarFallbackBody: "メール送信はまだ接続中です。先に通知設定を保存し、カレンダー通知も追加して毎日戻れるようにできます。",
      ...
      ko: {
        ...
        calendarFallbackBody: "이메일 발송은 아직 연결 중입니다. 먼저 알림 설정을 저장하고 캘린더 알림도 내려받아 매일 돌아올 수 있습니다.",
