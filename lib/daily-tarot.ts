  ...
  return (
    {
      zh: {
        ...
        reminderSavedPending: "邮箱偏好已保存在此设备；邮件发送启用前，请先使用日历提醒。",
        reminderSavedPendingSynced: "邮箱偏好已同步；邮件发送启用前，请先使用日历提醒。",
        reminderUnavailable: "邮件发送服务尚未启用。你可以先保存提醒偏好，并下载日历提醒让手机每天提醒你回来。",
        reminderEmailInvalid: "请输入有效的邮箱地址",
        emailSetupDisabled: "邮件提醒待接通",
        emailSetupPendingAction: "邮件发送尚未接通。可以先保存邮箱和时间偏好，再用日历提醒或回访链接回来。",
        emailReminderReadyTitle: "邮件提醒已可用",
        calendarFallbackTitle: "现在可用：日历提醒",
        calendarFallbackBody: "邮件发送服务尚未启用。你可以先保存邮箱和时间偏好；实际复访先用日历提醒或把回访链接发给自己。",
      ...
      en: {
        ...
        reminderSavedPending: "Email preference saved on this device; use the calendar reminder until email delivery is enabled.",
        reminderSavedPendingSynced: "Email preference synced; use the calendar reminder until email delivery is enabled.",
        ...
        emailSetupPendingAction: "Scheduled email is not connected yet. Save your email and time preference now, then use calendar reminders or email yourself the return link.",
        emailReminderReadyTitle: "Email reminders are ready",
        calendarFallbackTitle: "Available now: calendar reminder",
        calendarFallbackBody: "Email delivery is not enabled yet. You can save your email and time preference now; use a calendar reminder or email yourself the return link for the actual return.",
      ...
      ja: {
        ...
        reminderSavedPending: "メール設定をこの端末に保存しました。メール送信が有効になるまではカレンダー通知を使ってください。",
        reminderSavedPendingSynced: "メール設定を同期しました。メール送信が有効になるまではカレンダー通知を使ってください。",
        ...
        emailSetupPendingAction: "メール送信はまだ接続されていません。メールと時間を保存し、今はカレンダー通知か自分宛てリンクを使ってください。",
        emailReminderReadyTitle: "メール通知を利用できます",
        calendarFallbackTitle: "今すぐ使える: カレンダー通知",
        calendarFallbackBody: "メール送信はまだ有効ではありません。メールと時間の設定は保存できます。実際の再訪にはカレンダー通知か自分宛てリンクを使ってください。",
      ...
      ko: {
        ...
        reminderSavedPending: "이메일 설정이 이 기기에 저장되었습니다. 이메일 발송이 활성화되기 전에는 캘린더 알림을 사용하세요.",
        reminderSavedPendingSynced: "이메일 설정이 동기화되었습니다. 이메일 발송이 활성화되기 전에는 캘린더 알림을 사용하세요.",
        ...
        emailSetupPendingAction: "이메일 발송이 아직 연결되지 않았습니다. 이메일과 시간을 먼저 저장하고, 지금은 캘린더 알림이나 나에게 보내는 링크를 사용하세요.",
        emailReminderReadyTitle: "이메일 알림 사용 가능",
        calendarFallbackTitle: "지금 사용 가능: 캘린더 알림",
        calendarFallbackBody: "이메일 발송은 아직 활성화되지 않았습니다. 이메일과 시간 설정은 저장할 수 있습니다. 실제 재방문에는 캘린더 알림이나 나에게 보내는 링크를 사용하세요.",
