...
seoPageSources.push(
  ...
  makeQuestionSeoPage({
    slug: "does-she-miss-me-tarot",
    locales: ["en", "es", "pt-br"],
    cards: [6, 18, 20],
    recommendedSpread: "their_thoughts",
    title: "Does She Miss Me Tarot",
    description: "Ask a free AI tarot reading about whether she misses you, what her silence means, and whether longing may become healthy action.",
    h1: "Does She Miss Me Tarot",
    intent: "Best for silence, delayed replies, emotional distance, no-contact periods, and whether nostalgia is likely to become action.",
    question: "Does she miss me, and what does her silence really mean?",
    sections: [
      { heading: "Missing someone is not the whole answer", body: "A useful reading separates nostalgia, attraction, guilt, loneliness, and the willingness to act with care." },
      { heading: "Compare silence with behavior", body: "The cards should show whether distance is protection, avoidance, overwhelm, pride, or a sign that the connection needs a clearer conversation." },
      { heading: "Choose a grounded next step", body: "Instead of waiting for reassurance, use the advice card to decide whether to pause, reach out gently, set a boundary, or move your attention back to yourself." },
    ],
    faqs: [
      { question: "Can tarot tell if she misses me?", answer: "Tarot can reflect longing, attention, and emotional tone, but missing someone matters most when it connects with respectful action." },
      { question: "What cards suggest she misses me?", answer: "Six of Cups, The Moon, Page of Cups, Judgement, Two of Cups, and Five of Cups can suggest missing energy when the full spread supports it." },
    ],
  }),
  makeQuestionSeoPage({
    slug: "is-she-hiding-her-feelings-tarot",
    locales: ["en", "es", "pt-br"],
    cards: [2, 12, 18],
    recommendedSpread: "their_thoughts",
    title: "Is She Hiding Her Feelings Tarot",
    description: "Use a free AI tarot reading to explore whether she is hiding feelings, why she may hold back, and what you should observe next.",
    h1: "Is She Hiding Her Feelings Tarot",
    intent: "Best for mixed signals, guarded behavior, private emotion, fear of vulnerability, and whether hidden feelings may become clearer.",
    question: "Is she hiding her feelings, and what should I observe before I act?",
    sections: [
      { heading: "Hidden feelings need context", body: "Cards can suggest attraction or fear, but the useful question is whether hidden emotion is becoming honest behavior." },
      { heading: "Look for the reason she holds back", body: "The spread may point to fear, timing, pride, uncertainty, another priority, or emotional unavailability." },
      { heading: "Protect your clarity", body: "If the reading shows guarded energy, choose one calm observation, question, or boundary instead of chasing proof." },
    ],
    faqs: [
      { question: "Can tarot show hidden feelings?", answer: "It can explore private emotion, guarded behavior, and likely motives. It should be read alongside real communication and consistency." },
  ...
  makeQuestionSeoPage({
    slug: "why-did-she-pull-away-tarot",
    locales: ["en", "es", "pt-br"],
    cards: [9, 12, 18],
    recommendedSpread: "their_thoughts",
    title: "Why Did She Pull Away Tarot",
    description: "Draw a free AI tarot reading about why she pulled away, what changed, and the healthiest next step when someone becomes distant.",
    h1: "Why Did She Pull Away Tarot",
    intent: "Best for sudden distance, fewer texts, avoidant behavior, dating uncertainty, and deciding whether to wait, talk, or step back.",
    question: "Why did she pull away, and what is the healthiest next step for me?",
    sections: [
      { heading: "Distance can have several causes", body: "The reading should separate fear, overwhelm, loss of interest, outside pressure, unresolved conflict, and avoidant patterns." },
      { heading: "Do not make silence your only evidence", body: "Use the spread to compare what changed, what she may be avoiding, and what you can actually observe." },
      { heading: "Move from anxiety to action", body: "The advice card should give one grounded next step: wait briefly, ask directly, stop overgiving, or choose distance yourself." },
    ],
    faqs: [
      { question: "Can tarot explain why she pulled away?", answer: "Tarot can reflect emotional patterns, possible motives, and timing, but it cannot replace direct conversation or observable behavior." },
      { question: "What cards suggest someone pulling away?", answer: "The Hermit, Four of Cups, Eight of Cups, The Moon, The Hanged Man, and Seven of Swords can show distance when supported by the spread." },
    ],
  }),
  makeQuestionSeoPage({
  ...
  makeQuestionSeoPage({
    slug: "will-i-get-money-tarot",
    locales: ["en", "es", "pt-br"],
    cards: [1, 50, 77],
    recommendedSpread: "three_card",
    title: "Will I Get Money Tarot",
    description: "Draw a free AI tarot reading about money improvement, income timing, practical resources, and the next grounded step.",
    h1: "Will I Get Money Tarot",
    intent: "Best for wondering whether money may improve, what resource is opening, and what practical action supports the possibility.",
    question: "Will I get money, and what practical step should I take next?",
    sections: [
      { heading: "Read money as opportunity plus action", body: "A useful reading can show opening, delay, scarcity, effort, or support, but it should still name what you can do in the real world." },
      { heading: "Look for resources, not guarantees", body: "Positive cards may point to income, help, savings, a job lead, or a better plan. They are signals to investigate, not a promise to spend." },
      { heading: "Ground the answer in facts", body: "Use the cards to notice timing and attitude, then compare the answer with budgets, contracts, applications, invoices, and actual options." },
    ],
    faqs: [
      { question: "Can tarot tell if I will get money?", answer: "Tarot can reflect money themes, openings, and blocks, but POPTarot treats it as reflection, not financial prediction or advice." },
      { question: "What cards suggest money coming in?", answer: "Ace of Pentacles, Ten of Pentacles, Six of Pentacles, The Magician, Wheel of Fortune, and King of Pentacles can support money movement when the full spread agrees." },
      { question: "What should I do after a positive money reading?", answer: "Take one practical step: follow up on income, check a budget, ask for payment, negotiate, save, or reduce a real risk." },
    ],
  }),
  makeQuestionSeoPage({
    slug: "should-i-spend-money-tarot",
    locales: ["en", "es", "pt-br"],
    cards: [4, 11, 64],
    recommendedSpread: "yes_no",
    title: "Should I Spend Money Tarot",
    description: "Use a free AI tarot reading to reflect before spending money, compare need, risk, timing, value, and a practical next step.",
    h1: "Should I Spend Money Tarot",
    intent: "Best for a purchase, subscription, trip, course, gift, or material choice where you need a pause before acting.",
    question: "Should I spend this money now, or wait?",
    sections: [
      { heading: "Pause before the purchase", body: "A spending reading is useful when it separates desire, pressure, timing, value, and whether waiting would protect your stability." },
      { heading: "Ask what the cost is really buying", body: "The cards can show whether the purchase supports growth, solves a real problem, soothes anxiety, or creates avoidable strain." },
      { heading: "Make the answer practical", body: "A yes still needs a budget. A no or not yet should point to what to check first: price, timing, alternatives, debt, or real need." },
    ],
    faqs: [
      { question: "Can tarot decide if I should spend money?", answer: "It can help you reflect on timing, value, pressure, and risk, but it should not replace budgeting or financial advice." },
      { question: "What cards warn against spending?", answer: "Four of Pentacles, Five of Pentacles, The Devil, Seven of Cups, and reversed Temperance can warn against rushed or emotional spending when supported by the spread." },
      { question: "What is a better follow-up question?", answer: "Ask what practical detail should be checked before spending: budget, timing, hidden cost, alternative, or whether the purchase solves the real need." },
    ],
  }),
  makeQuestionSeoPage({
    slug: "financial-future-tarot-reading",
    locales: ["en", "es", "pt-br"],
    cards: [10, 14, 63],
    recommendedSpread: "three_card",
    title: "Financial Future Tarot Reading",
    description: "Start a free AI tarot reading about your financial future, money patterns, resources, timing, and one practical next move.",
    h1: "Financial Future Tarot Reading",
    intent: "Best for a reflective financial check-in about patterns, resources, timing, money pressure, and the next controllable step.",
    question: "What should I understand about my financial future and next practical move?",
    sections: [
      { heading: "Use future as direction, not certainty", body: "A financial future reading should show the direction of a pattern if nothing changes, then help you choose the next grounded adjustment." },
      { heading: "Watch repeated money patterns", body: "The spread may reveal cycles around scarcity, avoidance, overgiving, ambition, support, or discipline that shape the future more than one lucky event." },
      { heading: "Turn the reading into a plan", body: "The most useful outcome is a practical action: protect cash flow, build a skill, apply, negotiate, save, or ask for qualified advice." },
    ],
    faqs: [
      { question: "Can tarot predict my financial future?", answer: "No tarot reading should be treated as a financial prediction. POPTarot frames it as reflection on patterns, timing, and practical next steps." },
      { question: "Is this financial future tarot reading free?", answer: "Yes. You can start this reading for free. Membership is only for deeper follow-ups, saved history, advanced spreads, and longer reports." },
      { question: "Should I use tarot for investments?", answer: "Use tarot only for emotional reflection and risk awareness. Investment decisions require facts, planning, and qualified financial guidance." },
    ],
  }),
  makeQuestionSeoPage({
...
export const localizedSeoSlugs: Partial<Record<SeoLocale, Record<string, string>>> = {
  es: {
    ...
    "will-i-get-money-tarot": "recibire-dinero-tarot",
    "should-i-spend-money-tarot": "debo-gastar-dinero-tarot",
    "financial-future-tarot-reading": "lectura-tarot-futuro-financiero",
    ...
    "does-she-miss-me-tarot": "ella-me-extrana-tarot",
    "is-she-hiding-her-feelings-tarot": "ella-oculta-sus-sentimientos-tarot",
    "why-did-she-pull-away-tarot": "por-que-ella-se-alejo-tarot",
  ...
  "pt-br": {
    ...
    "will-i-get-money-tarot": "vou-receber-dinheiro-tarot",
    "should-i-spend-money-tarot": "devo-gastar-dinheiro-tarot",
    "financial-future-tarot-reading": "leitura-tarot-futuro-financeiro",
    ...
    "does-she-miss-me-tarot": "ela-sente-minha-falta-tarot",
    "is-she-hiding-her-feelings-tarot": "ela-esconde-os-sentimentos-tarot",
    "why-did-she-pull-away-tarot": "por-que-ela-se-afastou-tarot",
...
const regionalSeoCopy: Record<RegionalLocale, Partial<Record<string, RegionalPageCopy>>> = {
  es: {
    ...
    "does-she-miss-me-tarot": {
      title: "Tarot: ¿ella me extraña?",
      description: "Lectura gratis con IA sobre si ella te extraña, qué significa su silencio y si esa nostalgia puede volverse acción sana.",
      eyebrow: "Silencio y nostalgia",
      h1: "Tarot: ¿ella me extraña?",
      intro: "Pregunta si ella te extraña y qué significa su silencio. La lectura separa nostalgia, orgullo, distancia, deseo y acción real.",
      intent: "Ideal para respuestas tardías, contacto cero, distancia emocional y dudas sobre si extrañar puede convertirse en una conversación sana.",
      ctaQuestion: "¿Ella me extraña y qué significa realmente su silencio?",
      sections: [
        { heading: "Extrañar no lo resuelve todo", body: "Una lectura útil separa nostalgia, atracción, culpa, soledad y disposición real para actuar con cuidado." },
        { heading: "Compara silencio con conducta", body: "Las cartas deben mostrar si la distancia protege, evita, abruma, nace del orgullo o pide una conversación más clara." },
        { heading: "Elige un paso con tierra", body: "En vez de esperar seguridad externa, usa el consejo para pausar, escribir con calma, poner un límite o volver a ti." },
      ],
      faqs: [
        { question: "¿El tarot puede decir si ella me extraña?", answer: "Puede reflejar añoranza, atención y tono emocional, pero extrañar importa más cuando se conecta con acciones respetuosas." },
        { question: "¿Qué cartas sugieren que ella me extraña?", answer: "Seis de Copas, La Luna, Paje de Copas, El Juicio, Dos de Copas y Cinco de Copas pueden sugerir nostalgia si la tirada acompaña." },
      ],
    },
    "is-she-hiding-her-feelings-tarot": {
      title: "Tarot: ¿ella oculta sus sentimientos?",
      description: "Lectura gratis con IA sobre si ella oculta sentimientos, por qué se contiene y qué deberías observar antes de actuar.",
      eyebrow: "Sentimientos ocultos",
      h1: "Tarot: ¿ella oculta sus sentimientos?",
      intro: "Pregunta si ella está ocultando lo que siente y qué señales conviene observar sin perseguir una prueba.",
      intent: "Ideal para señales mixtas, conducta reservada, miedo a mostrarse vulnerable y dudas sobre si una emoción privada puede aclararse.",
      ctaQuestion: "¿Ella oculta sus sentimientos y qué debo observar antes de actuar?",
      sections: [
        { heading: "Lo oculto necesita contexto", body: "Las cartas pueden sugerir atracción o miedo, pero la pregunta útil es si esa emoción se convertirá en conducta honesta." },
        { heading: "Mira por qué se contiene", body: "La tirada puede señalar miedo, timing, orgullo, incertidumbre, otra prioridad o poca disponibilidad emocional." },
        { heading: "Protege tu claridad", body: "Si aparece energía reservada, elige una observación, pregunta o límite tranquilo en vez de perseguir certeza." },
      ],
      faqs: [
        { question: "¿El tarot puede mostrar sentimientos ocultos?", answer: "Puede explorar emoción privada, conducta reservada y motivos probables. Léelo junto con comunicación y consistencia reales." },
        { question: "¿Qué cartas sugieren sentimientos ocultos?", answer: "La Sacerdotisa, La Luna, Dos de Espadas, Paje de Copas, El Colgado y Cuatro de Copas pueden señalar sentimientos privados o demorados." },
      ],
    },
    "why-did-she-pull-away-tarot": {
      title: "Tarot: ¿por qué ella se alejó?",
      description: "Lectura gratis con IA sobre por qué ella se alejó, qué cambió y cuál es el siguiente paso más sano cuando alguien toma distancia.",
      eyebrow: "Distancia y señales",
      h1: "Tarot: ¿por qué ella se alejó?",
      intro: "Pregunta por qué ella se alejó y cómo pasar de la ansiedad a un paso claro, sin hacer del silencio la única evidencia.",
      intent: "Ideal para distancia repentina, menos mensajes, conducta evitativa, incertidumbre en citas y decidir si esperar, hablar o tomar distancia.",
      ctaQuestion: "¿Por qué ella se alejó y cuál es el siguiente paso más sano para mí?",
      sections: [
        { heading: "La distancia puede tener varias causas", body: "La lectura debe separar miedo, saturación, pérdida de interés, presión externa, conflicto pendiente y patrones evitativos." },
        { heading: "No uses solo el silencio como prueba", body: "Compara qué cambió, qué puede estar evitando y qué conducta real puedes observar." },
        { heading: "Pasa de ansiedad a acción", body: "La carta de consejo debe dar un paso concreto: esperar poco, preguntar directo, dejar de sobreentregar o tomar distancia tú." },
      ],
      faqs: [
        { question: "¿El tarot puede explicar por qué ella se alejó?", answer: "Puede reflejar patrones emocionales, posibles motivos y timing, pero no reemplaza una conversación directa ni conducta observable." },
        { question: "¿Qué cartas sugieren que alguien se aleja?", answer: "El Ermitaño, Cuatro de Copas, Ocho de Copas, La Luna, El Colgado y Siete de Espadas pueden mostrar distancia si la tirada lo confirma." },
      ],
    },
    ...
    "will-i-get-money-tarot": {
      title: "Tarot: ¿recibire dinero?",
      description: "Lectura gratis con IA sobre mejora economica, ingresos, recursos, timing y el siguiente paso practico.",
      eyebrow: "Dinero y oportunidad",
      h1: "Tarot: ¿recibire dinero?",
      intro: "Pregunta si puede abrirse una mejora economica y que accion realista conviene tomar ahora.",
      intent: "Ideal para dudas sobre ingresos, pagos pendientes, ayuda, recursos y como apoyar una posible mejora con accion concreta.",
      ctaQuestion: "¿Recibire dinero y que paso practico debo tomar ahora?",
      sections: [
        { heading: "Lee oportunidad con accion", body: "La lectura puede mostrar apertura, demora, escasez, esfuerzo o apoyo, pero debe terminar en algo verificable." },
        { heading: "Busca recursos, no garantias", body: "Una carta positiva puede senalar ingreso, ayuda, ahorro o mejor plan. No es permiso para gastar sin revisar numeros." },
        { heading: "Aterriza la respuesta", body: "Compara la tirada con presupuesto, contratos, pagos, solicitudes, facturas y opciones reales antes de decidir." },
      ],
      faqs: [
        { question: "¿El tarot puede decir si recibire dinero?", answer: "Puede reflejar temas de dinero, aperturas y bloqueos, pero POPTarot lo trata como reflexion, no como prediccion financiera." },
        { question: "¿Que cartas sugieren dinero entrando?", answer: "As de Oros, Diez de Oros, Seis de Oros, El Mago, Rueda de la Fortuna y Rey de Oros pueden apoyar movimiento si la tirada acompaña." },
        { question: "¿Que hago despues de una lectura positiva?", answer: "Da un paso practico: revisar presupuesto, pedir pago, negociar, ahorrar, reducir riesgo o buscar una fuente real de ingreso." },
      ],
    },
    "should-i-spend-money-tarot": {
      title: "Tarot: ¿debo gastar dinero?",
      description: "Lectura gratis con IA para reflexionar antes de gastar: necesidad, riesgo, timing, valor y siguiente paso practico.",
      eyebrow: "Gasto y decision",
      h1: "Tarot: ¿debo gastar dinero?",
      intro: "Pregunta si conviene gastar ahora o esperar. La lectura compara deseo, presion, necesidad, valor y estabilidad.",
      intent: "Ideal para compras, suscripciones, viajes, cursos, regalos o decisiones materiales que piden una pausa.",
      ctaQuestion: "¿Debo gastar este dinero ahora o esperar?",
      sections: [
        { heading: "Pausa antes de comprar", body: "La tirada separa deseo, urgencia, timing, valor real y si esperar protegeria tu estabilidad." },
        { heading: "Pregunta que compra el gasto", body: "La respuesta puede mostrar si el gasto resuelve un problema real, calma ansiedad o crea presion evitable." },
        { heading: "Haz practica la respuesta", body: "Un si necesita presupuesto. Un no o todavia no debe mostrar que revisar: precio, deuda, alternativa o necesidad real." },
      ],
      faqs: [
        { question: "¿El tarot puede decidir si debo gastar?", answer: "Puede ayudarte a reflexionar sobre timing, valor, presion y riesgo, pero no reemplaza presupuesto ni asesoria financiera." },
        { question: "¿Que cartas advierten contra gastar?", answer: "Cuatro de Oros, Cinco de Oros, El Diablo, Siete de Copas y Templanza invertida pueden advertir gasto impulsivo si la tirada lo confirma." },
        { question: "¿Cual es una mejor pregunta de seguimiento?", answer: "Pregunta que detalle practico revisar antes: presupuesto, timing, costo oculto, alternativa o necesidad real." },
      ],
    },
    "financial-future-tarot-reading": {
      title: "Lectura de tarot del futuro financiero",
      description: "Lectura gratis con IA sobre futuro financiero, patrones de dinero, recursos, timing y un movimiento practico.",
      eyebrow: "Futuro financiero",
      h1: "Lectura de tarot del futuro financiero",
      intro: "Pregunta por la direccion de tu situacion financiera y que ajuste concreto puede mejorar el camino.",
      intent: "Ideal para revisar patrones economicos, recursos, presion financiera, timing y el siguiente paso controlable.",
      ctaQuestion: "¿Que debo entender sobre mi futuro financiero y mi proximo movimiento practico?",
      sections: [
        { heading: "Futuro como direccion", body: "La lectura muestra hacia donde va un patron si nada cambia y que ajuste puede moverlo." },
        { heading: "Observa patrones repetidos", body: "Escasez, evasion, exceso, ambicion, apoyo o disciplina pueden pesar mas que un evento afortunado." },
        { heading: "Convierte la claridad en plan", body: "La accion util puede ser cuidar flujo de caja, aprender una habilidad, postular, negociar, ahorrar o pedir ayuda calificada." },
      ],
      faqs: [
        { question: "¿El tarot puede predecir mi futuro financiero?", answer: "No debe tratarse como prediccion financiera. POPTarot lo usa para reflexionar sobre patrones, timing y pasos practicos." },
        { question: "¿Esta lectura es gratis?", answer: "Si. Puedes empezar gratis. La membresia queda para seguimientos profundos, historial y reportes mas largos." },
        { question: "¿Puedo usar tarot para inversiones?", answer: "Usalo solo para reflexion emocional y conciencia de riesgo. Invertir exige datos, planificacion y orientacion financiera calificada." },
      ],
    },
  ...
  "pt-br": {
    ...
    "does-she-miss-me-tarot": {
      title: "Tarot: ela sente minha falta?",
      description: "Leitura grátis com IA sobre se ela sente sua falta, o que o silêncio significa e se a saudade pode virar ação saudável.",
      eyebrow: "Silêncio e saudade",
      h1: "Tarot: ela sente minha falta?",
      intro: "Pergunte se ela sente sua falta e o que o silêncio significa. A leitura separa saudade, orgulho, distância, desejo e ação real.",
      intent: "Ideal para respostas demoradas, contato zero, distância emocional e dúvidas sobre se a saudade pode virar conversa saudável.",
      ctaQuestion: "Ela sente minha falta e o que o silêncio dela realmente significa?",
      sections: [
        { heading: "Sentir falta não resolve tudo", body: "Uma leitura útil separa saudade, atração, culpa, solidão e disposição real para agir com cuidado." },
        { heading: "Compare silêncio com atitudes", body: "As cartas devem mostrar se a distância protege, evita, sobrecarrega, nasce do orgulho ou pede conversa mais clara." },
        { heading: "Escolha um passo concreto", body: "Em vez de esperar segurança externa, use o conselho para pausar, escrever com calma, colocar limite ou voltar para si." },
      ],
      faqs: [
        { question: "O tarot pode dizer se ela sente minha falta?", answer: "Pode refletir saudade, atenção e tom emocional, mas sentir falta importa mais quando se conecta com atitudes respeitosas." },
        { question: "Que cartas sugerem que ela sente minha falta?", answer: "Seis de Copas, A Lua, Pajem de Copas, O Julgamento, Dois de Copas e Cinco de Copas podem sugerir saudade se a tiragem apoiar." },
      ],
    },
    "is-she-hiding-her-feelings-tarot": {
      title: "Tarot: ela esconde os sentimentos?",
      description: "Leitura grátis com IA sobre se ela esconde sentimentos, por que se segura e o que observar antes de agir.",
      eyebrow: "Sentimentos ocultos",
      h1: "Tarot: ela esconde os sentimentos?",
      intro: "Pergunte se ela está escondendo o que sente e que sinais observar sem perseguir uma prova.",
      intent: "Ideal para sinais mistos, comportamento reservado, medo de vulnerabilidade e dúvidas sobre se uma emoção privada pode ficar clara.",
      ctaQuestion: "Ela esconde os sentimentos e o que devo observar antes de agir?",
      sections: [
        { heading: "O oculto precisa de contexto", body: "As cartas podem sugerir atração ou medo, mas a pergunta útil é se essa emoção vai virar comportamento honesto." },
        { heading: "Veja por que ela se segura", body: "A tiragem pode apontar medo, timing, orgulho, incerteza, outra prioridade ou pouca disponibilidade emocional." },
        { heading: "Proteja sua clareza", body: "Se aparecer energia reservada, escolha uma observação, pergunta ou limite calmo em vez de perseguir certeza." },
      ],
      faqs: [
        { question: "O tarot pode mostrar sentimentos ocultos?", answer: "Pode explorar emoção privada, comportamento reservado e motivos prováveis. Leia junto com comunicação e consistência reais." },
        { question: "Que cartas sugerem sentimentos ocultos?", answer: "A Sacerdotisa, A Lua, Dois de Espadas, Pajem de Copas, O Enforcado e Quatro de Copas podem indicar sentimentos privados ou demorados." },
      ],
    },
    "why-did-she-pull-away-tarot": {
      title: "Tarot: por que ela se afastou?",
      description: "Leitura grátis com IA sobre por que ela se afastou, o que mudou e o próximo passo mais saudável quando alguém cria distância.",
      eyebrow: "Distância e sinais",
      h1: "Tarot: por que ela se afastou?",
      intro: "Pergunte por que ela se afastou e como sair da ansiedade para um passo claro, sem fazer do silêncio a única evidência.",
      intent: "Ideal para distância repentina, menos mensagens, comportamento evitativo, incerteza em encontros e decidir se espera, conversa ou recua.",
      ctaQuestion: "Por que ela se afastou e qual é o próximo passo mais saudável para mim?",
      sections: [
        { heading: "Distância pode ter várias causas", body: "A leitura deve separar medo, sobrecarga, perda de interesse, pressão externa, conflito pendente e padrões evitativos." },
        { heading: "Não use só o silêncio como prova", body: "Compare o que mudou, o que ela pode estar evitando e que comportamento real você consegue observar." },
        { heading: "Saia da ansiedade para ação", body: "A carta de conselho deve dar um passo concreto: esperar pouco, perguntar direto, parar de se doar demais ou tomar distância." },
      ],
      faqs: [
        { question: "O tarot pode explicar por que ela se afastou?", answer: "Pode refletir padrões emocionais, possíveis motivos e timing, mas não substitui conversa direta nem comportamento observável." },
        { question: "Que cartas sugerem afastamento?", answer: "O Eremita, Quatro de Copas, Oito de Copas, A Lua, O Enforcado e Sete de Espadas podem mostrar distância se a tiragem confirmar." },
      ],
    },
    "will-we-get-back-together-tarot": {
    ...
    "will-i-get-money-tarot": {
      title: "Tarot: vou receber dinheiro?",
      description: "Leitura grátis com IA sobre melhora financeira, renda, recursos, timing e o próximo passo prático.",
      eyebrow: "Dinheiro e oportunidade",
      h1: "Tarot: vou receber dinheiro?",
      intro: "Pergunte se uma melhora financeira pode se abrir e que ação realista convém tomar agora.",
      intent: "Ideal para dúvidas sobre renda, pagamentos pendentes, ajuda, recursos e como apoiar uma possível melhora com ação concreta.",
      ctaQuestion: "Vou receber dinheiro e que passo prático devo tomar agora?",
      sections: [
        { heading: "Leia oportunidade com ação", body: "A tiragem pode mostrar abertura, atraso, escassez, esforço ou apoio, mas deve terminar em algo verificável." },
        { heading: "Procure recursos, não garantias", body: "Uma carta positiva pode indicar renda, ajuda, economia ou plano melhor. Não é permissão para gastar sem revisar números." },
        { heading: "Aterre a resposta", body: "Compare a tiragem com orçamento, contratos, pagamentos, pedidos, faturas e opções reais antes de decidir." },
      ],
      faqs: [
        { question: "O tarot pode dizer se vou receber dinheiro?", answer: "Pode refletir temas de dinheiro, aberturas e bloqueios, mas POPTarot trata como reflexão, não previsão financeira." },
        { question: "Que cartas sugerem dinheiro entrando?", answer: "Ás de Ouros, Dez de Ouros, Seis de Ouros, O Mago, Roda da Fortuna e Rei de Ouros podem apoiar movimento se a tiragem concorda." },
        { question: "O que faço depois de uma leitura positiva?", answer: "Dê um passo prático: revisar orçamento, pedir pagamento, negociar, economizar, reduzir risco ou buscar uma fonte real de renda." },
      ],
    },
    "should-i-spend-money-tarot": {
      title: "Tarot: devo gastar dinheiro?",
      description: "Leitura grátis com IA para refletir antes de gastar: necessidade, risco, timing, valor e próximo passo prático.",
      eyebrow: "Gasto e decisão",
      h1: "Tarot: devo gastar dinheiro?",
      intro: "Pergunte se convém gastar agora ou esperar. A leitura compara desejo, pressão, necessidade, valor e estabilidade.",
      intent: "Ideal para compras, assinaturas, viagens, cursos, presentes ou decisões materiais que pedem uma pausa.",
      ctaQuestion: "Devo gastar este dinheiro agora ou esperar?",
      sections: [
        { heading: "Pause antes de comprar", body: "A tiragem separa desejo, urgência, timing, valor real e se esperar protegeria sua estabilidade." },
        { heading: "Pergunte o que o gasto compra", body: "A resposta pode mostrar se o gasto resolve um problema real, acalma ansiedade ou cria pressão evitável." },
        { heading: "Torne a resposta prática", body: "Um sim precisa de orçamento. Um não ou ainda não deve mostrar o que revisar: preço, dívida, alternativa ou necessidade real." },
      ],
      faqs: [
        { question: "O tarot pode decidir se devo gastar?", answer: "Pode ajudar a refletir sobre timing, valor, pressão e risco, mas não substitui orçamento nem orientação financeira." },
        { question: "Que cartas alertam contra gastar?", answer: "Quatro de Ouros, Cinco de Ouros, O Diabo, Sete de Copas e Temperança invertida podem alertar contra gasto impulsivo se a tiragem confirma." },
        { question: "Qual é uma pergunta melhor de acompanhamento?", answer: "Pergunte que detalhe prático revisar antes: orçamento, timing, custo oculto, alternativa ou necessidade real." },
      ],
    },
    "financial-future-tarot-reading": {
      title: "Leitura de tarot do futuro financeiro",
      description: "Leitura grátis com IA sobre futuro financeiro, padrões de dinheiro, recursos, timing e um movimento prático.",
      eyebrow: "Futuro financeiro",
      h1: "Leitura de tarot do futuro financeiro",
      intro: "Pergunte pela direção da sua situação financeira e que ajuste concreto pode melhorar o caminho.",
      intent: "Ideal para revisar padrões financeiros, recursos, pressão, timing e o próximo passo controlável.",
      ctaQuestion: "O que devo entender sobre meu futuro financeiro e meu próximo movimento prático?",
      sections: [
        { heading: "Futuro como direção", body: "A leitura mostra para onde um padrão vai se nada mudar e que ajuste pode mover o caminho." },
        { heading: "Observe padrões repetidos", body: "Escassez, evasão, excesso, ambição, apoio ou disciplina podem pesar mais que um evento de sorte." },
        { heading: "Transforme clareza em plano", body: "A ação útil pode ser cuidar do fluxo de caixa, aprender uma habilidade, candidatar-se, negociar, economizar ou pedir ajuda qualificada." },
      ],
      faqs: [
        { question: "O tarot pode prever meu futuro financeiro?", answer: "Não deve ser tratado como previsão financeira. POPTarot usa como reflexão sobre padrões, timing e passos práticos." },
        { question: "Esta leitura é grátis?", answer: "Sim. Você pode começar grátis. A assinatura fica para acompanhamentos profundos, histórico e relatórios maiores." },
        { question: "Posso usar tarot para investimentos?", answer: "Use apenas para reflexão emocional e consciência de risco. Investir exige dados, planejamento e orientação financeira qualificada." },
      ],
    },
    "yes-or-no-tarot-love": {
