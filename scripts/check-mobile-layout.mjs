...
const pages = [
  ...
  },
  {
    ...
    requiredSelectors: [
      "[data-trust-page]",
      "[data-trust-page-slug=\"about\"]",
      "[data-trust-highlight-section]",
      "[data-trust-editorial-process]",
  ...
  },
  {
    ...
    requiredSelectors: [
      "[data-trust-page]",
      "[data-trust-page-slug=\"what-is-poptarot\"]",
      "[data-trust-highlight-section]",
      "[data-trust-editorial-process]",
      "[data-trust-default-free-action]",
    ],
  },
  {
    ...
    name: "official channels trust page",
    requiredSelectors: [
      "[data-trust-page]",
      "[data-trust-page-slug=\"official-channels\"]",
      "[data-trust-official-channels]",
      "[data-trust-official-website]",
      "[data-trust-official-socials]",
      "[data-trust-official-verification-links]",
      "[data-trust-official-verification-link]",
      "[data-official-brand-verification-facts]",
  ...
  {
    path: "/brand-assets",
    name: "brand assets trust page",
    requiredSelectors: [
      "[data-trust-page]",
      "[data-trust-page-slug=\"brand-assets\"]",
      "[data-trust-brand-assets]",
      "[data-trust-brand-asset]",
  ...
  },
  {
    ...
    name: "editorial policy trust page",
    requiredSelectors: [
      "[data-trust-page]",
      "[data-trust-page-slug=\"editorial-policy\"]",
      "[data-trust-highlight-section]",
      "[data-trust-editorial-process]",
      "[data-trust-editorial-process-step]",
      "[data-trust-default-free-action]",
    ],
  },
  {
    path: "/ai-tarot-disclaimer",
    name: "AI disclaimer trust page",
    requiredSelectors: [
      "[data-trust-page]",
      "[data-trust-page-slug=\"ai-tarot-disclaimer\"]",
      "[data-trust-highlight-section]",
      "[data-trust-editorial-process]",
      "[data-trust-default-free-action]",
    ],
  ...
  {
    path: "/privacy",
    name: "privacy trust page",
    requiredSelectors: [
      "[data-trust-page]",
      "[data-trust-page-slug=\"privacy\"]",
      "[data-trust-highlight-section]",
      "[data-trust-editorial-process]",
      "[data-trust-default-free-action]",
    ],
