...
const requiredSitemapPaths = [
  ...
  "/daily-mood-tarot",
  "/daily-action-tarot",
  "/es/carta-tarot-del-dia",
  "/es/carta-diaria-tarot",
  "/es/carta-tarot-amor-del-dia",
  "/es/tarot-diario-amor",
  "/es/tarot-diario-carrera",
  "/es/tarot-diario-si-o-no",
  "/es/tarot-diario-estado-de-animo",
  "/es/tarot-diario-accion",
  "/pt-br/carta-tarot-do-dia",
  "/pt-br/carta-diaria-tarot",
  "/pt-br/carta-tarot-amor-do-dia",
  ...
  "/weekly-love-tarot",
  "/weekly-career-tarot",
  "/es/lectura-tarot-semanal",
  "/es/tarot-semanal-amor",
  "/es/tarot-semanal-carrera",
  "/pt-br/leitura-tarot-semanal",
  "/pt-br/tarot-semanal-amor",
  "/pt-br/tarot-semanal-carreira",
  "/es/recibire-dinero-tarot",
  "/es/debo-gastar-dinero-tarot",
  "/es/lectura-tarot-futuro-financiero",
  "/pt-br/vou-receber-dinheiro-tarot",
  "/pt-br/devo-gastar-dinheiro-tarot",
  "/pt-br/leitura-tarot-futuro-financeiro",
