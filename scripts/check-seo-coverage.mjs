...
assertIncludes(files.globalStyles, "--home-hero-content-reserve: 56rem", "homepage mobile content reserve prevents overlap under browser chrome")
assertIncludes(files.globalStyles, "max(176svh, calc(var(--home-hero-content-y) + var(--home-hero-content-reserve)))", "homepage mobile shell keeps following content below hero actions")
