...
const dailyReminderCoverage = [
  ...
  [files.reminderCapability, "service_role_key", "reminder missing service role key capability"],
  [files.reminderCapability, "missing_service_role_key", "reminder database access mode for missing service key"],
  [files.reminderCapability, "service_role_rpc", "reminder database access mode for service role RPC"],
  ...
  [files.readme, "`server_service_key_configured`, `database_rpc_accessible`, `unsubscribe_rpc_accessible`, and `can_send_email_reminders` should be `true`", "production reminder strict status README"],
