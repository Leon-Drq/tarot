...
assertIncludes(files.globalStyles, "max(205svh, calc(var(--home-hero-content-y) + var(--home-hero-content-reserve)))", "homepage mobile shell keeps following content below hero actions")
