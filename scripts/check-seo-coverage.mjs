...
const files = {
  ...
  questionIntent: { path: "lib/question-intent.ts", source: read("lib/question-intent.ts") },
  tarotSpreadsPage: {
  ...
  contactPage: {
    ...
    source: read("app/contact/page.tsx"),
  },
  ...
  reminderEdgeFunction: {
    path: "supabase/functions/poptarot-daily-reminders/index.ts",
    source: read("supabase/functions/poptarot-daily-reminders/index.ts"),
  },
  reminderSchedule: {
...
assertIncludes(files.mobileCheck, 'waitUntil: "domcontentloaded"', "mobile check waits for DOM instead of fragile network idle")
assertIncludes(files.mobileCheck, "async function waitForSelectors", "mobile check waits for required UI selectors")
assertIncludes(files.mobileCheck, "pageConfig.embeddedTopGuard", "mobile check waits for embedded browser top guard")
assertIncludes(files.mobileCheck, "attempt < 3", "mobile check retries mobile menu opening")
...
assertIncludes(files.freeToolsPage, "questionClusterSources", "free tools question cluster source data")
assertIncludes(files.freeToolsPage, "questionClusters", "free tools question cluster hydrated data")
assertIncludes(files.freeToolsPage, "data-free-tools-question-clusters", "free tools visible question cluster section")
assertIncludes(files.freeToolsPage, "data-free-tools-question-cluster", "free tools visible question cluster cards")
assertIncludes(files.freeToolsPage, "data-free-tools-question-cluster-link", "free tools question cluster links")
assertIncludes(files.freeToolsPage, "data-free-tools-question-cluster-start", "free tools question cluster direct CTA")
assertIncludes(files.freeToolsPage, "data-free-tools-question-cluster-guide", "free tools question cluster guide CTA")
assertIncludes(files.freeToolsPage, "utm_medium: \"question_cluster\"", "free tools question cluster attribution")
assertIncludes(files.freeToolsPage, "utm_content: clusterKey", "free tools question cluster source attribution")
assertIncludes(files.freeToolsPage, "#question-clusters", "free tools question cluster structured data")
assertIncludes(files.freeToolsPage, "Start free tarot question reading", "free tools question cluster structured action")
assertIncludes(files.freeToolsPage, "/does-my-crush-like-me-tarot", "free tools question cluster love slug")
assertIncludes(files.freeToolsPage, "/will-my-ex-reach-out-tarot", "free tools question cluster ex slug")
assertIncludes(files.freeToolsPage, "/weekly-love-tarot", "free tools question cluster return slug")
assertIncludes(files.freeToolsPage, "/will-i-get-the-job-tarot", "free tools question cluster career slug")
...
for (const [needle, label] of [
  ...
  ["clusterEyebrow", "localized free tools cluster eyebrow copy"],
  ["clusterTitle", "localized free tools cluster title copy"],
  ["clusters: [", "localized free tools question cluster data"],
  ["questionClusterItems", "localized free tools question cluster hydration"],
  ["questionClusterReadingHref", "localized free tools question cluster direct reading href"],
  ["data-free-tools-question-clusters", "localized free tools question cluster visible section"],
  ["data-free-tools-question-cluster-start", "localized free tools question cluster CTA"],
  ["data-free-tools-question-cluster-guide", "localized free tools question cluster guide"],
  ["utm_medium: \"question_cluster\"", "localized free tools question cluster attribution"],
  ["#question-clusters", "localized free tools question cluster structured data"],
  ["will-my-ex-reach-out-tarot", "localized free tools ex contact cluster slug"],
  ["will-i-get-the-job-tarot", "localized free tools career cluster slug"],
...
const sitemapHreflangCoverage = [
  ...
  [files.sitemap, "mergeSitemapRoutes", "sitemap duplicate route merge helper"],
  [files.sitemap, "Math.max(existing.priority, route.priority)", "sitemap duplicate route keeps highest priority"],
  [files.sitemap, "Array.from(new Set([...(existing.images || []), ...(route.images || [])]))", "sitemap duplicate route merges image signals"],
  [files.searchAssetCheck, "dailyTarotSitemapBlock", "search asset verifies Daily Tarot merged sitemap signals"],
  [files.searchAssetCheck, "<priority>0.92</priority>", "search asset verifies Daily Tarot sitemap priority"],
...
const trustDataCoverage = [
  ...
  [files.contactPage, 'getTrustMetadata("contact")', "Contact route metadata"],
  [files.contactPage, 'getTrustPage("contact")', "Contact route data"],
  [files.trustPages, 'type: "ContactPage"', "contact trust page schema type"],
  [files.trustPages, "Official POPTarot contact and support paths", "contact page support copy"],
  [files.trustPages, "/reviews?surface=contact", "contact page feedback path"],
  [files.site, 'url: `${appUrl}/contact`', "Organization contact point URL"],
  [files.site, '"Contact path"', "official verification contact link"],
  [files.mobileCheck, 'path: "/contact"', "contact mobile check route"],
  [files.mobileCheck, '[data-trust-page-slug=\\"contact\\"]', "contact mobile selector"],
  ...
  [files.trustPageView, "data-trust-highlight-section", "trust page visible trust signal section"],
  [files.trustPageView, "data-trust-editorial-process", "trust page visible editorial process section"],
  [files.trustPageView, "data-trust-editorial-process-step", "trust page visible editorial process step"],
  ...
  [files.trustPageView, "data-trust-brand-assets", "brand assets visible section"],
  [files.trustPageView, "data-trust-brand-asset", "brand asset visible cards"],
  [files.trustPageView, "data-trust-brand-asset-open", "brand asset direct file links"],
  ...
  [files.trustPageView, "data-trust-official-channels", "official channels visible section"],
  [files.trustPageView, "data-trust-official-website", "official canonical website card"],
  [files.trustPageView, "data-trust-official-socials", "official social verification card"],
  [files.trustPageView, "data-trust-official-verification-links", "official verification visible link section"],
  [files.trustPageView, "data-trust-official-verification-link", "official verification visible links"],
  ...
  [files.mobileCheck, 'path: "/official-channels"', "official channels mobile check route"],
  [files.mobileCheck, '[data-trust-page-slug=\\"official-channels\\"]', "official channels mobile selector"],
  [files.mobileCheck, 'path: "/brand-assets"', "brand assets mobile check route"],
  [files.mobileCheck, '[data-trust-page-slug=\\"brand-assets\\"]', "brand assets mobile selector"],
  [files.mobileCheck, 'path: "/editorial-policy"', "editorial policy mobile check route"],
  [files.mobileCheck, '[data-trust-page-slug=\\"editorial-policy\\"]', "editorial policy mobile selector"],
  [files.mobileCheck, 'path: "/ai-tarot-disclaimer"', "AI disclaimer mobile check route"],
  [files.mobileCheck, '[data-trust-page-slug=\\"ai-tarot-disclaimer\\"]', "AI disclaimer mobile selector"],
  [files.mobileCheck, 'path: "/privacy"', "privacy mobile check route"],
  [files.mobileCheck, '[data-trust-page-slug=\\"privacy\\"]', "privacy mobile selector"],
]
...
const identityMetadataCoverage = [
  ...
  [files.serviceWorker, "const CACHE_VERSION = \"poptarot-return-v4\"", "PWA cache version bumps stale homepage shells"],
  [files.serviceWorker, "NAVIGATION_CACHE_EXCLUDE_PATHS", "PWA homepage bypasses navigation cache"],
  [files.serviceWorker, "shouldBypassNavigationCache", "PWA homepage navigation cache bypass guard"],
...
const searchAssetRuntimeCoverage = [
  ...
  [files.searchAssetCheck, "parseIcoSizes", "search asset ICO directory parser"],
  [files.searchAssetCheck, "requiredIcoSizes = [16, 32, 48, 96]", "search asset required ICO dimensions"],
  [files.searchAssetCheck, "`/favicon.ico missing ${required}x${required}", "search asset ICO dimension failure"],
  ...
  [files.searchAssetCheck, "\"/contact\"", "search asset contact sitemap check"],
...
const tarotCardRankingCoverage = [
  ...
  [files.tarotCardSeo, "What does ${englishName} mean for career?", "English career FAQ"],
  [files.tarotCardSeo, "What does ${englishName} mean for money?", "English money FAQ"],
  [files.tarotCardSeo, "Is ${englishName} a yes or no card?", "English yes-or-no FAQ"],
  ...
  [files.tarotCardSeo, "Que significa ${name} para carrera?", "Spanish career FAQ"],
  [files.tarotCardSeo, "Que significa ${name} para dinero?", "Spanish money FAQ"],
  [files.tarotCardSeo, "O que ${name} significa para carreira?", "Portuguese career FAQ"],
  [files.tarotCardSeo, "O que ${name} significa para dinheiro?", "Portuguese money FAQ"],
  [files.tarotCardSeo, "${name} es una carta de si o no?", "Spanish yes-or-no FAQ"],
  [files.tarotCardSeo, "${name} e uma carta de sim ou nao?", "Portuguese yes-or-no FAQ"],
  ...
  [files.cardMeaningPage, "data-card-quick-answer", "card page quick answer visible section"],
...
const dailyReminderCoverage = [
  ...
  [files.reminderCapability, "hasSupabaseServiceKey", "reminder Supabase service role key capability"],
  [files.reminderCapability, "server_service_key_configured", "reminder service key status payload"],
  [files.reminderCapability, "database_rpc_accessible", "reminder database RPC status payload"],
  [files.reminderCapability, "unsubscribe_configured", "reminder unsubscribe capability"],
  [files.reminderCapability, "unsubscribe_rpc_accessible", "reminder unsubscribe RPC status payload"],
  [files.reminderCapability, "checkDailyReminderUnsubscribeAccess", "reminder unsubscribe RPC capability check"],
  [files.reminderCapability, "configuredReminderDatabaseAccessMode", "reminder configured database access mode"],
  [files.reminderCapability, "database_access", "reminder missing database access capability"],
  [files.reminderCapability, "edge_function", "reminder database access mode for Edge Function proxy"],
  [files.reminderRpc, "\"service_role_rpc\"", "reminder database access mode for service role RPC"],
  ...
  [files.reminderCheckScript, "server_service_key_configured", "reminder capability service key output"],
  [files.reminderCheckScript, "database_rpc_accessible", "reminder capability database RPC output"],
  [files.reminderCheckScript, "unsubscribe_rpc_accessible", "reminder capability unsubscribe RPC output"],
  [files.reminderCheckScript, "reminder_database_access_mode", "reminder capability access mode output"],
  ...
  [files.readme, "`database_rpc_accessible`, `unsubscribe_rpc_accessible`, and `can_send_email_reminders` should be `true`", "production reminder strict status README"],
  ...
  [files.reminderRpc, "poptarot-daily-reminders", "reminder Edge Function proxy name"],
  [files.reminderRpc, "callReminderEdgeFunction", "reminder Edge Function fallback helper"],
  [files.reminderRpc, "configuredReminderDatabaseAccessMode", "reminder configured access mode helper"],
  [files.reminderRpc, "\"edge_function\"", "reminder Edge Function access mode"],
  [files.reminderEdgeFunction, "Deno.serve", "reminder Edge Function handler"],
  [files.reminderEdgeFunction, "x-cron-secret", "reminder Edge Function custom cron secret auth"],
  [files.reminderEdgeFunction, "SUPABASE_SERVICE_ROLE_KEY", "reminder Edge Function reads default service role"],
  [files.reminderEdgeFunction, "SUPABASE_SECRET_KEYS", "reminder Edge Function supports secret keys"],
  [files.reminderEdgeFunction, "daily_tarot_reminder_candidates", "reminder Edge Function candidates RPC"],
  [files.reminderEdgeFunction, "mark_daily_tarot_reminder_sent", "reminder Edge Function sent marker RPC"],
  [files.reminderEdgeFunction, "disable_daily_tarot_reminders", "reminder Edge Function unsubscribe RPC"],
...
const publicShareConversionCoverage = [
  ...
  [files.sharePage, "publicShareDailyReturnHref", "public share focused Daily Tarot return helper"],
  [files.sharePage, "return_focus: question", "public share Daily Tarot return focus"],
  [files.sharePage, "data-public-share-daily-return-focus", "public share focused Daily Tarot return CTA"],
  [files.sharePage, "#daily-return-action", "public share Daily Tarot structured return action"],
  [files.sharePage, "Open Daily Tarot for this shared reading", "public share WebPage Daily Tarot structured action"],
  [files.sharePage, "Daily Tarot return path for this shared reading", "public share Daily Tarot structured app node"],
  [files.sharePage, "Return tomorrow with Daily Tarot", "public share Daily Tarot structured follow-up action"],
  ...
  [files.shareCopyActions, "dailyReturnUrl?: string", "public share accepts focused Daily Tarot return URL"],
  [files.shareCopyActions, "focusedDailyReturnUrl", "public share focused Daily Tarot return URL"],
  [files.shareCopyActions, "return_focus: question", "public share fallback Daily Tarot return focus"],
...
const freeFirstReadingCoverage = [
  ...
  [files.questionIntent, "export function classifyQuestionIntent", "shared question intent classifier"],
  [files.questionIntent, "export function getQuestionIntentPrompt", "intent-specific AI prompt helper"],
  [files.questionIntent, "export function getQuestionIntentFollowUps", "intent-specific follow-up suggestions"],
  [files.questionIntent, "export function getQuestionIntentResultStructure", "intent-specific result structure"],
  [files.questionIntent, "love: \"their_thoughts\"", "love questions map to relationship spread"],
  [files.questionIntent, "reconciliation: \"breakup_recovery\"", "reconciliation questions map to breakup recovery spread"],
  [files.questionIntent, "career: \"job_opportunity\"", "career questions map to job opportunity spread"],
  ...
  [files.readingRoute, "classifyQuestionIntent", "reading API classifies question intent"],
  [files.readingRoute, "getQuestionIntentPrompt", "reading API injects intent-specific answer structure"],
  [files.readingRoute, "providerOptions", "reading API reports AI Gateway attribution"],
  [files.readingRoute, "tags: gatewayTags", "reading API sends AI Gateway tags"],
  [files.readingRoute, "question_type: questionIntent.type", "reading API metadata includes question intent"],
  ...
  [files.readingClassifyRoute, "question_type: intent.type", "classified question intent response"],
  [files.readingClassifyRoute, "recommended_spread_type: intent.recommendedSpreadType", "classified recommended spread response"],
  ...
  [files.inputPage, "data-input-spread-choice-dialog", "input spread choice dialog selector"],
  ...
  [files.inputPage, "Preparando el mazo", "input Spanish prep deck copy"],
  [files.inputPage, "Preparando o baralho", "input Portuguese prep deck copy"],
  ...
  [files.readingPage, "return_focus: question || \"Review this tarot reading\"", "free reading result focused Daily Tarot return URL"],
  [files.readingPage, "return_action: \"reminder\"", "free reading result Daily Tarot reminder return action"],
  ...
  [files.readingPage, "data-reading-result-structure", "reading result intent structure panel"],
  [files.readingPage, "data-reading-result-stage", "reading result intent stage chips"],
  ...
  [files.readingPage, "source: \"reading_followup\"", "reading follow-up membership attribution"],
