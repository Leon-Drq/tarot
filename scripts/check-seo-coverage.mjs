...
assertIncludes(files.globalStyles, "--home-hero-visual-browser-offset: min(var(--home-mobile-browser-offset, 0px), 3.25rem)", "homepage visual browser chrome offset cap")
assertIncludes(files.globalStyles, "--home-hero-focal-y: calc(var(--home-hero-visual-browser-offset) + clamp(24.75rem, 58svh, 28.5rem))", "homepage mobile focal centering with visual browser chrome offset")
